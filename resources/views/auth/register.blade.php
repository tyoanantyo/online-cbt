    ...
    <section id="signup" class="flex w-full min-h-[832px] relative">
        <nav class="flex items-center px-[50px] pt-[30px] w-full absolute top-0">
            <div class="flex items-center">
                <a href="index.html">
                    <img src="{{ asset('images/logo/logo.svg') }}" alt="logo" class="h-[60px] w-auto">
                </a>
            </div>
        ...
        <div class="left-side min-h-screen flex flex-col w-full pb-[30px] pt-[82px]">
            <div class="h-full w-full flex items-center justify-center">
                ...
                <form method="POST" action="{{ route('register') }}"
                    ...
                    <button type="submit"
                        class="w-full h-[52px] p-[14px_30px] bg-cyan-500 rounded-full font-bold text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center">Create
                        My Account</button>
                </form>
            </div>
        </div>
        <div class="right-side min-h-screen flex flex-col w-[650px] shrink-0 pb-[30px] pt-[82px] bg-cyan-500">
